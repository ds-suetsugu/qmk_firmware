...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LOWER] = KEYMAP( \
    ...
    PREVTAB, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,   KC_PERC, KC_CIRC, KC_AMPR,  KC_ASTR, KC_LPRN, KC_RPRN, NEXTTAB, \
    _______, KC_TILD, KC_GRV, KC_PIPE, KC_BSLS,   _______, _______, KC_LBRC,  KC_RBRC, KC_LCBR, KC_RCBR, _______, \
    _______, _______, _______, _______, KC_LANG2, KC_BSPC, KC_BSPC, KC_LANG1, _______, _______, _______, _______  \
  ),
