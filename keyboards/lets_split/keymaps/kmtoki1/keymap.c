...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY] = KEYMAP( \
    ...
    MO(RAISE),     KC_LANG2,       KC_LALT, KC_LGUI, MO(LOWER), SFT_T(KC_SPC),  SFT_T(KC_ENT),  MO(LOWER), KC_RGUI, KC_RALT, KC_LANG1,           MO(RAISE) \
  ),
  ...
  [LOWER] = KEYMAP( \
    ...
    _______, KC_TILD, KC_GRV,  KC_PIPE, KC_BSLS, KC_PLUS, KC_EQL,  KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, _______, \
    _______, KC_PIPE, KC_BSLS, KC_PLUS, KC_EQL,  KC_UNDS, KC_MINS, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, _______, \
