...
[QWERTY] = KEYMAP( \
  ...
  KC_LCTL, LT(LOWER,KC_BSPC), SFT_T(KC_SPC), SFT_T(KC_ENT), LT(RAISE,KC_DEL), KC_LALT\
),
 ...
 */
[QWERTY] = KEYMAP( \
  KC_QUT,  KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, \
...
[RAISE] = KEYMAP( \
  ...
  KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12 KC_TILD, KC_BSLS, KC_QUOT, ____,    \
  ____,  KC_IME, ____, ____, ____, ____ \
),
...
[LOWER] = KEYMAP( \
  ...
  KC_ESC,  ____,  ____,    ____,   ____,    ____,    KC_TILD, KC_PIPE, KC_DQT,  ____     \
...
[MISC] =  KEYMAP( \
  ...
  ____,  KC_MS_L,     KC_MS_D, KC_MS_R,       ____,    ____,    KC_LEFT,   KC_DOWN, KC_RIGHT, ____,       \
  ____,  ____,        ____,    ____,          ____,    ____,    ____,      ____,    ____,     TG(DVORAK), \
  KC_BTM3, KC_BTM2, KC_BTM1, ____, ____, ____ \
)
};
